...
$did=$_REQUEST['did'];
if($did!=''){
mysqli_query($con,"delete from bookcar where id='$did'") or die(mysqli_error());
...
<div class="bar"></div>
<div class="tablebox">
<div class="heading">BOOKING REPORTS</div><hr/>
<table border="1">
<tr>
...
<td><a href="booking_detail.php?eid=<?php echo $row['id'];?>"><span style="color:#999999;">Edit</span></a>&nbsp; | &nbsp;<a href="booking_reports.php?did=<?php echo $row['id'];?>"><span style="color:#999999;">Delete</span></a></td>
</tr>
<?php $i++;} ?>
</table>
</div>
