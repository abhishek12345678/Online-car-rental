...
if (isset($_POST['btn-login'])) {
	...
	if (password_verify($password, $row['password']) && $count==1) {
		...
		$msg = "<div class='alert alert-danger' style='width:46%;'>
...
<form method="post" > 
<div class="heading">ADMINISTRATION LOGIN</div><hr/>
<?php
		if(isset($msg)){
			echo $msg;
		}
...
<div class="button" align="right" style="margin-left:26.7%;">
<input type="submit" name="btn-login" value="Submit" style="width:60%; height:30px; background-color:#9F0000; color:#FFFFFF; border:1px solid #530000;"/>
</div>
<div class="button" align="left">
<input type="reset" value="Reset" style="width:55%; height:30px; background-color:#2D2D2D; color:#FFFFFF; border:1px solid #333333;"/>
</div>
</div>
</form>
</div>
